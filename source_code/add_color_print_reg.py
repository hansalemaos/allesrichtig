...
able_to_see_col_text = 'Everything is configured right! You should be able to see colored text'
        ...
        try:
            with WinRegistry() as client:
                try:
                    ...
                    regedit_entry = client.read_entry(REGEDITPATH, virtualterminalregedit)
                    ...
                    if int(regedit_entry.value) == 0:
                        ...
                        try:
                            client.write_entry(REGEDITPATH, virtualterminalregedit, value=1, reg_type=REG_DWORD)
                    ...
                    try:
                        client.write_entry(REGEDITPATH, "VirtualTerminalLevel", value=1, reg_type=REG_DWORD)
                        print(drucker.f.black.green.negative(regedit_success))
            ...
            print(drucker.f.black.brightred.negative('Error checking if VirtualTerminalLevel is set to 1'))
