...
| -------------------------------------------------------------- |- |
As you might have noticed already, this text has 3 errors.|<img src="33_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 2 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
The first time you start the app, it will download LanguageTool and store it in your .cache folder!|<img src="66_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 3 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Press 1 to correct your text.|<img src="99_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 4 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
Select the txt/docx/pdf/epub/pptx file with the text you want to correct.|<img src="132_800x800.png" width="400"/> |

| _,.-'``'-.,_,.'`` Step 5 ``'.,_,.-'``'-.,_|Screenshot|
| -------------------------------------------------------------- |- |
The app will show you all errors that it finds.|<img src="165_800x800.png" width="400"/> |
